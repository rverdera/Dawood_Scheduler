...
Public Class Copy_of_GoodsRetRep
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Copy of GoodsRetRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCopy_of_GoodsRetRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Copy_of_GoodsRetRep = New Copy_of_GoodsRetRep
        rpt.Site = Me.Site
        Return rpt
    End Function
