...
Public Class DailySalesInvByItem
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "DailySalesInvByItem.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDailySalesInvByItem
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DailySalesInvByItem = New DailySalesInvByItem
        rpt.Site = Me.Site
        Return rpt
    End Function
